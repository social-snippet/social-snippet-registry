...
database_name = case Padrino.env
  when :development then 'social_snippet_registry_development'
  when :production  then 'social_snippet_registry_production'
  when :test        then 'social_snippet_registry_test'
end
...
#     sessions:
#       default:
#         database: social_snippet_registry_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: social_snippet_registry_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: social_snippet_registry_test
#         hosts:
#           - localhost:27017
#
#

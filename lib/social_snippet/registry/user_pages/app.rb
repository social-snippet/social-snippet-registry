module SocialSnippet
  ...
  module Registry
    ...
    class UserPages < Padrino::Application
      ...
      get "/auth/github/callback" do
        ...
        github_user = api_client.user

        set_current_account nil
        user = authenticate_with_github(access_token)
        set_current_account(user) unless user.nil?
      ...
      # set :public_folder, 'dist/' # Location for static assets (default root/public)
